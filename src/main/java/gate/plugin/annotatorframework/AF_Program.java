...
public class AF_Program extends AbstractLanguageAnalyser {

  private static final Logger log = Logger.getLogger(AF_Program.class);
  ...
  public Resource init() throws ResourceInstantiationException {
    log.debug("Run an annotator process as a command and interact via pipes. is initializing");
